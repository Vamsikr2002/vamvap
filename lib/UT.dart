...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final noof = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                myInput(
                  controler: start,
                  hint: 'Enter the carriage starting location',
                ),
                SizedBox(height: 15),
                myInput(controler: end, hint: 'Enter the destination'),
                SizedBox(height: 15),
                myInput(controler: noof, hint: 'Enter the number of carriages'),
                SizedBox(height: 15),
                ElevatedButton(
  ...
  Widget myInput({required TextEditingController controler, required String hint}) {
    return TextField(
